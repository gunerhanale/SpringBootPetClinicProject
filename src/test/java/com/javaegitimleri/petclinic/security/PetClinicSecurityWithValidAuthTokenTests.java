...
public class PetClinicSecurityWithValidAuthTokenTests {
	...
	public void setUp() {
		...
		SecurityContextHolder.getContext().setAuthentication(auth);   //Bu SecurityContext işini bitirdikten sonra temizlenmesi gerek bunu tearDown metod ile sağlarız.
	}
