...
public class PetClinicRestController {
	...
	@Cacheable("allOwners")  //Data list'i cache'ledik
	...
	@RequestMapping(method = RequestMethod.GET, value = "/owner/{id}", produces = "application/json") // HATEOES USING
	public ResponseEntity<?> getOwnerAsHateoesResource(@PathVariable("id") Long id) {
		try {
